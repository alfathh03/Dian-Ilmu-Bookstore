...
import javax.swing.JOptionPane; // Untuk menampilkan dialog error
...
try {
        ...
        // Coba parsing harga dan stok menjadi angka
        double harga = Double.parseDouble(price);
        int kategori = Integer.parseInt(stock);

        DefaultTableModel model = (DefaultTableModel) tb1.getModel();
        Object[] row = {title, author, harga, kategori};
        model.addRow(row);
        
        JOptionPane.showMessageDialog(this, "Data berhasil disimpan!");
    } catch (NumberFormatException nfe) {
        JOptionPane.showMessageDialog(this, "Harga dan Kategori harus berupa angka!", "Input Error", JOptionPane.ERROR_MESSAGE);
    } catch (Exception ex) {
